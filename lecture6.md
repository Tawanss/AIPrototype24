...
## 1. **สคริปต์ฝั่งผู้ใช้** [`call_web_service.py`](https://github.com/Tawanss/AIPrototype24/blob/main/call_web_sevice.py): 
...
## 2. **API ฝั่งเซิร์ฟเวอร์** [`firstflask.py`](https://github.com/Tawanss/AIPrototype24/blob/main/firstflask.py): 
